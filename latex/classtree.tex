...
\-Insert function\-: \-Compares which \char`\"{}slots\char`\"{} are empty in each node. \-Also compares values to insert in the right position. 

\-If the node is full, we create a new node to insert more data \hypertarget{classtree_a70b27ff892cb18aac183f210148a84fa}{\index{tree@{tree}!search@{search}}
